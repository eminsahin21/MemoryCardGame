...
class OnePlayerLevel_2_Activity : AppCompatActivity() {

    lateinit var firestore: FirebaseFirestore
    private val db = Firebase.firestore
    private val filename = "medium_1PL.txt"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_one_player_level2)

        //süre hesabı
        val time: TextView = findViewById(R.id.suretext_1PL_2LVL)
    ...
    private fun onclick_card(
        ...
        val image7: ImageView = findViewById(R.id.image_7)
        val image8: ImageView = findViewById(R.id.image_8)
        val image9: ImageView = findViewById(R.id.image_9)
        val image10: ImageView = findViewById(R.id.image_10)
        val image11: ImageView = findViewById(R.id.image_11)
        val image12: ImageView = findViewById(R.id.image_12)
        val image13: ImageView = findViewById(R.id.image_13)
        val image14: ImageView = findViewById(R.id.image_14)
        val image15: ImageView = findViewById(R.id.image_15)
        val image16: ImageView = findViewById(R.id.image_16)
    ...
    private fun puanHesapla(
        ...
        var scoretext: TextView = findViewById(R.id.scoretext_1PL_2LVL)
